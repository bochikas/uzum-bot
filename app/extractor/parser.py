...
class UzumParser:
    ...
    async def fetch_product(self, url: str) -> ProductMinifiedSchema:
        async with async_playwright() as p:
            ...
            try:
                logger.info("parsing single product started")
    ...
    async def fetch_all_product_updates(self) -> dict[int, UpdatedProductSchema]:
        updated_products: dict[int, UpdatedProductSchema] = {}
                    ...
                    for product in products:
                        ...
                        try:  # noqa WPS229
                            if not product.title:
                                product.title = await self.parse_product_title(page=page)
                            ...
                            if not product_price or new_price != product_price:
                                updated_products[product.id] = UpdatedProductSchema(
